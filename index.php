...
<body>
    ...
    <div id="mySidebar" class="sidebar">
        <div class="list-group list-group-flush mx-3 mt-4">
          <a href="/student" class="list-group-item list-group-item-action py-4 ripple d-flex active" aria-current="true">
          ...
          <a href="#" class="list-group-item list-group-item-action py-4 ripple d-flex ">
          <i class='fas fa-graduation-cap fa-fw me-3'></i><span>Course2</span>
          </a>
          <a href="#" class="list-group-item list-group-item-action py-4 ripple d-flex ">
          <i class='fas fa-graduation-cap fa-fw me-3'></i><span>Course3</span>
          </a>
          <a href="#" class="list-group-item list-group-item-action py-4 ripple d-flex ">
          <i class='fas fa-graduation-cap fa-fw me-3'></i><span>Course4</span>
          </a>
        </div>
